...
public class crearNotificaciones {
    ...
    public String dibujarCreadorNotificaciones(String mensaje) {
        ...
        _notificacion = "\n"
                ...
                + "                                        <label class=\"mdl-textfield__label\" for=\"titulo\" style=\"\">Título</label>\n"
                + "                                    </div>\n"
                + "                                    <br>\n"
                ...
                + "                                    \n"
                + "                                    <input type=\"submit\" class=\"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--primary\" value=\"subir notificación\">\n"
                + "                                    <br>\n"
                + "                                </form>\n"
                + "                            </center>\n"
                + "                        </div>\n"
                ...
                + "\n"
                + "            }\n"
                + "            document.querySelector('#titulo').addEventListener('keyup', llenarTitulo, false);\n"
                + "\n"
