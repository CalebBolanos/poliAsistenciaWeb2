...
public class crearNotificaciones {
    ...
    public String dibujarCreadorNotificaciones(String mensaje) {
        ...
        _notificacion = "\n"
                ...
                + "                                        <input class=\"mdl-textfield__input\" type=\"text\" id=\"tit\" name=\"tit\" maxlength=\"100\" onkeyup=\"contarTitulo(this);\" required>\n"
                + "                                        <label class=\"mdl-textfield__label\" for=\"tit\" style=\"\">Título</label>\n<span class=\"mdl-textfield__error\" id=\"contadorTitulo\" style=\"visibility: visible !important; color: #bababa !important;\">0/100</span>"
                + "                                    </div>\n"
                + "                                    <br>\n"
                + "                                    <div class=\"mdl-textfield mdl-js-textfield\">\n"
                + "                                        <textarea class=\"mdl-textfield__input\" type=\"text\" rows= \"3\" id=\"info\" name=\"info\" maxlength=\"250\" onkeyup=\"contarDescripcion(this);\" required></textarea>\n"
                + "                                        <label class=\"mdl-textfield__label\" for=\"info\">Descripción</label>\n<span class=\"mdl-textfield__error\" id=\"contadorDescripcion\" style=\"visibility: visible !important; color: #bababa !important;\">0/250</span>"
                + "                                    </div>\n"
                + "\n"
                + "                                    <br><br>\n"
                + "                                    <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
                + "                                        <input class=\"mdl-textfield__input\" type=\"text\" id=\"url\" name=\"url\" maxlength=\"300\" required>\n"
                ...
                + "                 }"
                + "            };\n"
                + "         function contarDescripcion(contenido){\n"
                + "             document.getElementById('contadorDescripcion').innerHTML = contenido.value.length+'/250';\n"
                + "         }"
                + "         function contarTitulo(contenido){\n"
                + "             document.getElementById('contadorTitulo').innerHTML = contenido.value.length+'/100';\n"
                + "         }"
                + "        </script>\n"
                + "    </body>\n"
                + "</html>\n"
