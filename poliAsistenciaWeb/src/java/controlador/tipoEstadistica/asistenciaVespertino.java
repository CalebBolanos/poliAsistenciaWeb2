 ...
 * @author Caleb
 */
@WebServlet(name = "asistenciaVespertino", urlPatterns = {"/estadisticas/asistenciaVespertino"})
public class asistenciaVespertino extends HttpServlet {
                ...
                if (tipoPersona == 3) {//profesor
                    ...
                    if (tipoPersona == 4) {//jefe de academia
                        ...
                        if (tipoPersona == 1) {//gestion
                            ...
                            gestion.asistenciaVespertino persona = new gestion.asistenciaVespertino(idPersona, tipoPersona, numero, nombre);
                            out.print(persona.dibujarAsistenciaVespertino());
                        }
                    }
                }
            }
