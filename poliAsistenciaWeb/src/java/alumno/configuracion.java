...
public class configuracion {
    ...
    public configuracion(int idPersona, int idTipo, String nombre, String paterno, String materno, String genero, String boleta, String nacimiento) {
    ...
    public String dibujarConfiguracion(String mensaje) {
        ...
        _configuracion = "<!DOCTYPE html>\n"
                ...
                + "                                    <span style=\"font-size: 17px; color: gray\">Alumno</span>\n"
                + "                                </p>\n"
                + "                            </div>\n"
                + "                            <div class=\"mdl-grid center-items\">\n"
                ...
                + "                                                </div>\n"
                + "                                                <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
                + "                                                    <input class=\"mdl-textfield__input\" type=\"text\" id=\"boleta\" name=\"boleta\" value=\"" + _boleta + "\" disabled>\n"
                + "                                                    <label class=\"mdl-textfield__label\" for=\"boleta\">No. de Boleta</label>\n"
                + "                                                </div>\n"
                + "                                                <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
                ...
                + "                                                        <label class=\"mdl-textfield__label\" for=\"nueva\">Nueva Contraseña</label>   \n"
                + "                                                    </div>\n"
                + "                                                    <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
