...
public class asistenciaGrupo {
    ...
    public asistenciaGrupo(int idPersona, int idTipo, String numero, String nombre, String grupo) {
    ...
    public String dibujarAsistenciaGrupo() {
        ArrayList<Object> datosUnidad = new ArrayList<>(datosGrupoEspecifico(_grupo));
...
//=============================================================================================================================================================================
        ...
        if (mes > Calendar.JULY && mes < Calendar.DECEMBER + 1) {//Ciclo 1
            if (mes > Calendar.JULY) {
                ArrayList<Object> datosAsistenciaAgosto = new ArrayList<>(asistenciaGrupoMes(8, _grupo));
            ...
            if (mes > Calendar.AUGUST) {
                ArrayList<Object> datosAsistenciaSeptiembre = new ArrayList<>(asistenciaGrupoMes(9, _grupo));
            ...
            if (mes > Calendar.SEPTEMBER) {
                ArrayList<Object> datosAsistenciaOctubre = new ArrayList<>(asistenciaGrupoMes(10, _grupo));
            ...
            if (mes > Calendar.OCTOBER) {
                ArrayList<Object> datosAsistenciaNoviembre = new ArrayList<>(asistenciaGrupoMes(11, _grupo));
            ...
            if (mes > Calendar.NOVEMBER) {
                ArrayList<Object> datosAsistenciaDiciembre = new ArrayList<>(asistenciaGrupoMes(12, _grupo));
            ...
            if (mes > Calendar.JANUARY - 1 && mes < Calendar.AUGUST) {//Ciclo 2
                if (mes > Calendar.JANUARY - 1) {
                    ArrayList<Object> datosAsistenciaEnero = new ArrayList<>(asistenciaGrupoMes(1, _grupo));
                ...
                if (mes > Calendar.JANUARY) {
                    ArrayList<Object> datosAsistenciaFebrero = new ArrayList<>(asistenciaGrupoMes(2, _grupo));
                ...
                if (mes > Calendar.FEBRUARY) {
                    ArrayList<Object> datosAsistenciaMarzo = new ArrayList<>(asistenciaGrupoMes(3, _grupo));
                ...
                if (mes > Calendar.MARCH) {
                    ArrayList<Object> datosAsistenciaAbril = new ArrayList<>(asistenciaGrupoMes(4, _grupo));
                ...
                if (mes > Calendar.APRIL) {
                    ArrayList<Object> datosAsistenciaMayo = new ArrayList<>(asistenciaGrupoMes(5, _grupo));
                ...
                if (mes > Calendar.MAY) {
                    ArrayList<Object> datosAsistenciaJunio = new ArrayList<>(asistenciaGrupoMes(6, _grupo));
                ...
                if (mes > Calendar.JUNE) {
                    ArrayList<Object> datosAsistenciaJulio = new ArrayList<>(asistenciaGrupoMes(7, _grupo));
...
//==========================================================================================================================================================
        ArrayList<Object> asistenciaDia = new ArrayList<>(asistenciaGrupoDia(_grupo));
        ...
        _asistenciaUnidad = "<!DOCTYPE html>\n"
                ...
                + "                    <span style=\"color: #0091EA;\" class=\"titulos\">" + grupo + "</span>\n"
    ...
    private static java.util.List<java.lang.Object> datosGrupoEspecifico(java.lang.String grupo) {//informacionUnidad
    ...
    private static java.util.List<java.lang.Object> asistenciaGrupoMes(int mes, java.lang.String grupo) {//asistenciaUnidasMes
        serviciosWebGestion.Gestion_Service service = new serviciosWebGestion.Gestion_Service();
        serviciosWebGestion.Gestion port = service.getGestionPort();
        return port.asistenciaGrupoMes(mes, grupo);
    }

    private static java.util.List<java.lang.Object> asistenciaGrupoDia(java.lang.String grupo) {//asistenciaGrupoDia
        serviciosWebGestion.Gestion_Service service = new serviciosWebGestion.Gestion_Service();
        serviciosWebGestion.Gestion port = service.getGestionPort();
        return port.asistenciaGrupoDia(grupo);
    }
