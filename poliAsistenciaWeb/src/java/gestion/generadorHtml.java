...
public class generadorHtml {
    ...
    public String htmlInformacionMes(int mes, String totalClases, String promedioAsistido, String promedioFaltado, String htmlMes) {
        ...
        String informacion = "<div class=\"mdl-cell mdl-cell--6-col\">\n"//empieza
                ...
                + "                                <div style=\"background-color: white; width: 100%; padding: 3px; font-size: 12px;\">Clases impartidas: " + totalClases + " | Porcentaje de Asistencia: " + promedioAsistido + "% | Porcentaje de Inasistencia:" + promedioFaltado + "%</div>\n"
                + "                            </div>\n"
                + "                            \n"
                + "                        </div>\n"
                + "                        \n"
