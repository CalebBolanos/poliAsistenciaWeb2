 ...
 * @author Caleb
 */
public class editarNotificaciones {
    ...
    public editarNotificaciones(int idPersona, int idTipo, String numero, String nombre) {
    ...
    public String dibujarEditorNotificaciones(int idNoti) {
        ArrayList <Object> datosNotificacion = new ArrayList<>(obtenerNotificacionEspecifica(idNoti));
        String titulo = (String) datosNotificacion.get(2);
        String info = (String) datosNotificacion.get(3);
        String url = (String) datosNotificacion.get(4);
        ...
        _notificacion = "\n"
                ...
                + "                                        <input class=\"mdl-textfield__input\" type=\"text\" id=\"tit\" name=\"tit\" value=\""+titulo+"\" required>\n"
                + "                                        <label class=\"mdl-textfield__label\" for=\"tit\" style=\"\">Título</label>\n"
                + "                                    </div>\n"
                + "                                    <br>\n"
                + "                                    <div class=\"mdl-textfield mdl-js-textfield\">\n"
                + "                                        <textarea class=\"mdl-textfield__input\" type=\"text\" rows= \"3\" id=\"info\" name=\"info\"  required>"+info+"</textarea>\n"
                + "                                        <label class=\"mdl-textfield__label\" for=\"info\">Información</label>\n"
                + "                                    </div>\n"
                + "\n"
                + "                                    <br><br>\n"
                + "                                    <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
                + "                                        <input class=\"mdl-textfield__input\" type=\"text\" id=\"url\" name=\"url\" value=\""+url+"\" required>\n"
    ...
    private static java.util.List<java.lang.Object> obtenerNotificacionEspecifica(int id) {
        ...
        return port.obtenerNotificacionEspecifica(id);
    }
}
