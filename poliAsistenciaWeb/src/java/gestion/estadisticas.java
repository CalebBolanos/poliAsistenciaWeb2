...
public class estadisticas {
    ...
    public estadisticas(int idPersona, int idTipo, String numero, String nombre) {
    ...
    public String dibujarEstadisticas() {
        _estadisticas = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "    <head>\n"
                + "        <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\">\n"
                + "        <meta name=\"description\" content=\"PoliAsistencia\">\n"
                + "        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, minimum-scale=1.0\">\n"
                + "        <title>Estadisticas de Asistencia</title>\n"
                ...
                + "            }\n"
                + "            .iconos{\n"
                + "                width: 30%; height: inherit; position: relative; float: left;\n"
                ...
                + "            }\n"
                + "            .ajustarTabla{\n"
                + "                width: 100%; height: 376px; overflow: auto;\n"
                + "            }\n"
                + "            .ajusta{\n"
                ...
                + "                            <div class=\"mdl-grid center-items\">\n"
                + "                                <div class=\"mdl-cell mdl-cell--12-col\">\n"
                + "                                    <div class=\"descripcion\" style=\"width: 100%;\"><p class=\"tit\" style=\"color: #0091EA;\">Turnos</p></div>\n"
                + "                                </div>\n"
                + "                                <div class=\"mdl-cell mdl-cell--6-col\" >\n"
                + "                                    <div class=\"tarjetas\" style=\"height: 200px; box-shadow: 0 1px 2px rgba(0,0,0,0), 0 1px 2px rgba(0,0,0,0); border: 2px rgb(224, 224, 224) solid\">\n"
                + "                                        <div class=\"iconos\" style=\"width: 100%; height: 150px; background: linear-gradient(to right, rgb(0, 145, 234), rgb(0, 178, 255))\">\n"
                ...
                + "                                            <center>\n"
                + "                                                <a href=\"estadisticas/asistenciaMatutino\"><button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: #0091EA; width: 50%\">\n"
                + "                                                    Ver más detalles\n"
                + "                                                </button></a>\n"
                + "                                            </center>\n"
                + "                                        </div>\n"
                ...
                + "                                <div class=\"mdl-cell mdl-cell--6-col\" >\n"
                + "                                    <div class=\"tarjetas\" style=\"height: 200px; box-shadow: 0 1px 2px rgba(0,0,0,0), 0 1px 2px rgba(0,0,0,0); border: 2px rgb(224, 224, 224) solid\">\n"
                + "                                        <div class=\"iconos\" style=\"width: 100%; height: 150px; background: linear-gradient(to right, rgb(0, 229, 10), rgb(0, 238, 11))\">\n"
                + "                                            <p class=\"tit\" style=\"padding-top: 20px;\">\n"
                + "                                                Vespertino<br>\n"
                + "                                            </p>\n"
                + "                                        </div>\n"
                + "                                        <div class=\"descripcion\" style=\"width: 100%; height: 50px;\">\n"
                + "                                            <center>\n"
                + "                                                <a href=\"estadisticas/asistenciaVespertino\"><button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: rgb(0, 229, 10); width: 50%\">\n"
                + "                                                    Ver más detalles\n"
                + "                                                </button></a>\n"
                + "                                            </center>\n"
                + "                                        </div>\n"
                ...
                + "                        <div class=\"tarjetas\" style=\"height: 500px;\">\n"
                + "                            <div class=\"descripcion ajusta\" style=\"\">\n"
                + "                                <div style=\"background-color: white; width: 100%; color: #0091EA; font-size: 40px; padding-bottom: 20px;\" class=\"tituloMes\"><br>Grupos</div>\n"
                + "                                <div style=\"background-color: whitesmoke; width: 100%\" class=\"tituloMes\">\n"
                + "                                    <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
                + "                                        <input class=\"mdl-textfield__input\" type=\"text\"id=\"buscarGrupo\" name=\"buscarGrupo\">\n"
                + "                                        <label class=\"mdl-textfield__label\" for=\"buscarGrupo\">Buscar</label>\n"
                + "                                    </div>\n"
                + "                                </div>\n"
                ...
                + "                        <div class=\"tarjetas\" style=\"height: 500px;\">\n"
                + "                            <div class=\"descripcion ajusta\" style=\"\">\n"
                + "                                <div style=\"background-color: white; width: 100%; color: #0091EA; font-size: 40px; padding-bottom: 20px;\" class=\"tituloMes\"><br>Alumnos</div>\n"
                + "                                <div style=\"background-color: whitesmoke; width: 100%\" class=\"tituloMes\">\n"
                + "                                    <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n"
                + "                                        <input class=\"mdl-textfield__input\" type=\"text\" id=\"buscarAlumno\"  name=\"buscarAlumno\">\n"
                + "                                        <label class=\"mdl-textfield__label\" for=\"buscarAlumno\">Buscar</label>\n"
                + "                                    </div>\n"
                + "                                </div>\n"
                + "                                <div style=\"\" class=\"ajustarTabla\">\n"
                + "\n"
                ...
                + "                    <form action=\"estadisticas/asistenciaIndividual\" method=\"POST\" id=\"datosAlumno\">\n"
                + "                        <input type=\"text\" id=\"boleta\" name=\"boleta\" value=\"\"/>\n"
                + "                        <input type=\"text\" id=\"idPersona\" name=\"idPersona\" value=\"\"/>\n"
                + "                    </form>\n"
                + "                    <form action=\"estadisticas/asistenciaGrupo\" method=\"POST\" id=\"datosGrupo\">\n"
                + "                        <input type=\"text\" id=\"grupo\" name=\"grupo\" value=\"\"/>\n"
                + "                    </form>\n"
                + "                </div>\n"
                + "                <script>\n"
                + "                    function enviarAlumno(boleta, idPersona) {\n"
                + "                        document.getElementById(\"boleta\").value = boleta;\n"
                + "                        document.getElementById(\"idPersona\").value = idPersona;\n"
                + "                        document.getElementById(\"datosAlumno\").submit();\n"
                + "                        \n"
                + "                    }\n"
                + "                    function enviarGrupo(grupo) {\n"
                + "                        document.getElementById(\"grupo\").value = grupo;\n"
                + "                        document.getElementById(\"datosGrupo\").submit();\n"
                + "                        \n"
                + "                    }\n"
                + "\n"
                + "                </script>\n"
                ...
                + "        </div>\n"
                + "        <script>\n"
                + "            function busquedaAlumno(event) {\n"
                + "                var busqueda = event.target.value.toUpperCase();\n"
                + "                var filas = document.querySelector(\"#alumnos tbody\").rows;\n"
                + "\n"
                + "                for (var i = 0; i < filas.length; i++) {\n"
                + "                    var boleta = filas[i].cells[0].textContent.toUpperCase();\n"
                + "                    var nombre = filas[i].cells[1].textContent.toUpperCase();\n"
                + "                    var grupo = filas[i].cells[2].textContent.toUpperCase();\n"
                + "                    var turno = filas[i].cells[3].textContent.toUpperCase();\n"
                + "                    var semestre = filas[i].cells[4].textContent.toUpperCase();\n"
                + "                    var especialidad = filas[i].cells[5].textContent.toUpperCase();\n"
                + "                    if (boleta.indexOf(busqueda) > -1 || nombre.indexOf(busqueda) > -1 || grupo.indexOf(busqueda) > -1 || turno.indexOf(busqueda) > -1 || semestre.indexOf(busqueda) > -1 || especialidad.indexOf(busqueda) > -1) {\n"
                ...
                + "            }\n"
                + "\n"
                + "            document.querySelector('#buscarAlumno').addEventListener('keyup', busquedaAlumno, false);\n"
                + "\n"
                + "            function busquedaGrupo(event) {\n"
                + "                var busqueda = event.target.value.toUpperCase();\n"
                + "                var filas = document.querySelector(\"#grupos tbody\").rows;\n"
                + "\n"
                + "                for (var i = 0; i < filas.length; i++) {\n"
                + "                    var grupo = filas[i].cells[0].textContent.toUpperCase();\n"
                + "                    var semestre = filas[i].cells[1].textContent.toUpperCase();\n"
                + "                    var turno = filas[i].cells[2].textContent.toUpperCase();\n"
                + "                    var especialidad = filas[i].cells[3].textContent.toUpperCase();\n"
                + "                    if (grupo.indexOf(busqueda) > -1 || semestre.indexOf(busqueda) > -1 || turno.indexOf(busqueda) > -1 || especialidad.indexOf(busqueda) > -1) {\n"
                + "                        filas[i].style.display = \"\";\n"
                + "                    } else {\n"
                + "                        filas[i].style.display = \"none\";\n"
                + "                    }\n"
                ...
                + "            }\n"
                + "\n"
                + "            document.querySelector('#buscarGrupo').addEventListener('keyup', busquedaGrupo, false);\n"
                + "\n"
                + "\n"
                + "\n"
                + "        </script>\n"
