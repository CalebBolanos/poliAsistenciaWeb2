 ...
 * @author Caleb
 */
public class asistenciaVespertino{
    ...
    public asistenciaVespertino(int idPersona, int idTipo, String numero, String nombre) {
    ...
    public String dibujarAsistenciaVespertino() {

//=============================================================================================================================================================================
        String htmlInformacionMes = "";
        String scriptInformacionMes = "";
        String scriptGeneralMes = "";
        gestion.generadorHtml generar = new gestion.generadorHtml();
        ...
        if (mes > Calendar.JULY && mes < Calendar.DECEMBER + 1) {//Ciclo 1
            if (mes > Calendar.JULY) {
                ArrayList<Object> datosAsistenciaAgosto = new ArrayList<>(asistenciaTurnoMes(8, 2));
            ...
            if (mes > Calendar.AUGUST) {
                ArrayList<Object> datosAsistenciaSeptiembre = new ArrayList<>(asistenciaTurnoMes(9, 2));
            ...
            if (mes > Calendar.SEPTEMBER) {
                ArrayList<Object> datosAsistenciaOctubre = new ArrayList<>(asistenciaTurnoMes(10, 2));
            ...
            if (mes > Calendar.OCTOBER) {
                ArrayList<Object> datosAsistenciaNoviembre = new ArrayList<>(asistenciaTurnoMes(11, 2));
            ...
            if (mes > Calendar.NOVEMBER) {
                ArrayList<Object> datosAsistenciaDiciembre = new ArrayList<>(asistenciaTurnoMes(12, 2));
            ...
            if (mes > Calendar.JANUARY - 1 && mes < Calendar.AUGUST) {//Ciclo 2
                if (mes > Calendar.JANUARY - 1) {
                    ArrayList<Object> datosAsistenciaEnero = new ArrayList<>(asistenciaTurnoMes(1, 2));
                ...
                if (mes > Calendar.JANUARY) {
                    ArrayList<Object> datosAsistenciaFebrero = new ArrayList<>(asistenciaTurnoMes(2, 2));
                ...
                if (mes > Calendar.FEBRUARY) {
                    ArrayList<Object> datosAsistenciaMarzo = new ArrayList<>(asistenciaTurnoMes(3, 2));
                ...
                if (mes > Calendar.MARCH) {
                    ArrayList<Object> datosAsistenciaAbril = new ArrayList<>(asistenciaTurnoMes(4, 2));
                ...
                if (mes > Calendar.APRIL) {
                    ArrayList<Object> datosAsistenciaMayo = new ArrayList<>(asistenciaTurnoMes(5, 2));
                ...
                if (mes > Calendar.MAY) {
                    ArrayList<Object> datosAsistenciaJunio = new ArrayList<>(asistenciaTurnoMes(6, 2));
                ...
                if (mes > Calendar.JUNE) {
                    ArrayList<Object> datosAsistenciaJulio = new ArrayList<>(asistenciaTurnoMes(7, 2));
...
//==========================================================================================================================================================
        ArrayList<Object> asistenciaDia = new ArrayList<>(asistenciaTurnoPorDiaMas("2"));
        ...
        _asistenciaMatutino= "<!DOCTYPE html>\n"
                ...
                + "                    <span style=\"color: rgb(0, 229, 10);\" class=\"titulos\">Turno Vespertino</span>\n"
