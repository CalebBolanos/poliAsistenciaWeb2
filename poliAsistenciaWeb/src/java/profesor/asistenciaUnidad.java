 ...
 * @author Caleb
 */
public class asistenciaUnidad {

    private int _idPersona = 0;
    private int _idTipo = 0;
    private String _numero = "";
    private String _nombre = "";
    private String _asistenciaUnidad = "";
    private String _grupo = "";
    private String _unidad = "";

    public asistenciaUnidad(int idPersona, int idTipo, String numero, String nombre, String grupo, String unidad) {
    ...
    public String dibujarUnidad() {
        ArrayList<Object> datosUnidad = new ArrayList<>(informacionUnidad(_grupo, _unidad));
        String unidad = (String) datosUnidad.get(0);
        String grupo = (String) datosUnidad.get(1);
        String semestre = (String) datosUnidad.get(2);
        String turno = (String) datosUnidad.get(3);
        String especialidad = (String) datosUnidad.get(4);
        String noAlumnos = (String) datosUnidad.get(5);
...
//=============================================================================================================================================================================
        ...
        if (mes > Calendar.JULY && mes < Calendar.DECEMBER + 1) {//Ciclo 1
            if (mes > Calendar.JULY) {
                ArrayList<Object> datosAsistenciaAgosto = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 8));
            ...
            if (mes > Calendar.AUGUST) {
                ArrayList<Object> datosAsistenciaSeptiembre = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 9));
            ...
            if (mes > Calendar.SEPTEMBER) {
                ArrayList<Object> datosAsistenciaOctubre = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 10));
            ...
            if (mes > Calendar.OCTOBER) {
                ArrayList<Object> datosAsistenciaNoviembre = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 11));
            ...
            if (mes > Calendar.NOVEMBER) {
                ArrayList<Object> datosAsistenciaDiciembre = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 12));
            ...
            if (mes > Calendar.JANUARY - 1 && mes < Calendar.AUGUST) {//Ciclo 2
                if (mes > Calendar.JANUARY - 1) {
                    ArrayList<Object> datosAsistenciaEnero = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 1));
                ...
                if (mes > Calendar.JANUARY) {
                    ArrayList<Object> datosAsistenciaFebrero = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 2));
                ...
                if (mes > Calendar.FEBRUARY) {
                    ArrayList<Object> datosAsistenciaMarzo = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 3));
                ...
                if (mes > Calendar.MARCH) {
                    ArrayList<Object> datosAsistenciaAbril = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 4));
                ...
                if (mes > Calendar.APRIL) {
                    ArrayList<Object> datosAsistenciaMayo = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 5));
                ...
                if (mes > Calendar.MAY) {
                    ArrayList<Object> datosAsistenciaJunio = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 6));
                ...
                if (mes > Calendar.JUNE) {
                    ArrayList<Object> datosAsistenciaJulio = new ArrayList<>(asistenciaUnidasMes(Integer.parseInt(_unidad), 7));
...
//==========================================================================================================================================================
        ArrayList<Object> asistenciaDia = new ArrayList<>(asistenciaUnidadDia(_unidad));
        ...
        _asistenciaUnidad = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "    <head>\n"
                ...
                + "                    <span style=\"color: #0091EA;\" class=\"titulos\">" + unidad + " - " + grupo + "</span>\n"
                ...
                + "                                        <div class=\"iconos\" style=\"width: 100%; text-align: left; font-size: 25px; color: gray\">\n"
                + "                                            <p style=\"text-align: center; font-size: 35px; color: #0091EA; padding-top: 10px;\">Datos Generales</p>\n"
                + "                                            <span style=\"padding: 5px;\">-Grupo: " + grupo + "</span><br>\n"
                + "                                            <span style=\"padding: 5px;\">-Semestre: " + semestre + "</span><br>\n"
                + "                                            <span style=\"padding: 5px;\">-Turno: " + turno + "</span><br>\n"
                + "                                            <span style=\"padding: 5px;\">-Especialidad: " + especialidad + "</span><br>\n"
                + "                                            <span style=\"padding: 5px;\">-Alumnos Inscritos: " + noAlumnos + "</span><br>\n"
                + "                                        </div>\n"
                + "                                    </div>\n"
                + "                                </div>\n"
                ...
                + "</html>\n"
                + "";
        return _asistenciaUnidad;
    }

    private static java.util.List<java.lang.Object> informacionUnidad(java.lang.String grupo, java.lang.String idUnidad) {//datosGrupoEspecifico
    ...
    private static java.util.List<java.lang.Object> asistenciaUnidasMes(int idUnidad, int mes) {//asistenciaGrupoMes
        serviciosWebProfesor.Profesor_Service service = new serviciosWebProfesor.Profesor_Service();
        serviciosWebProfesor.Profesor port = service.getProfesorPort();
        return port.asistenciaUnidasMes(idUnidad, mes);
    }

    private static java.util.List<java.lang.Object> asistenciaUnidadDia(java.lang.String idUnidad) {//asistenciaGrupoDia
        serviciosWebProfesor.Profesor_Service service = new serviciosWebProfesor.Profesor_Service();
        serviciosWebProfesor.Profesor port = service.getProfesorPort();
        return port.asistenciaUnidadDia(idUnidad);
    }
