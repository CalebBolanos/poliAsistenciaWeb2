...
public class estadisticas {
    ...
    public String dibujarEstadisticas() {
        _estadisticas = "<!DOCTYPE html>\n"
                ...
                + "                            <div class=\"iconos\" style=\"width: 100%; height: 150px; background: linear-gradient(to right, rgb(240, 36, 0), rgb(255, 15, 0));\"><p class=\"tit\">Asistencia Individual</p></div>\n"
                + "                            <div class=\"descripcion\" style=\"width: 100%; height: 50px;\">\n"
                + "                                <center>\n"
                + "                                    <a href=\"estadisticas/asistenciaIndividual\"><button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: rgb(240, 36, 0); width: 50%\">\n"
                + "                                        Ver más detalles\n"
                + "                                    </button></a>\n"
                + "                                </center>\n"
                + "                            </div>\n"
                ...
                + "                            <div class=\"mdl-grid center-items\">\n"
                + "                                <div class=\"mdl-cell mdl-cell--12-col\">\n"
                + "                                    <div class=\"descripcion\" style=\"width: 100%;\"><p class=\"tit\" style=\"color: #0091EA;\">Grupos</p></div>\n"
                + "                                </div>\n"
                + "                                " + unidades(_idPersona) + " "
                + "\n"
                + "                            </div>\n"
                ...
                + "                    <form action=\"estadisticas/asistenciaUnidad\" method=\"POST\" id=\"datos\">\n"
                + "                        <input type=\"text\" id=\"grupo\" name=\"grupo\" value=\"\"/>\n"
                + "                        <input type=\"text\" id=\"idUnidad\" name=\"idUnidad\" value=\"\"/>\n"
                + "                    </form>\n"
                + "                </div>"
                + "                <script>\n"
                + "                    function enviar(grupo, idUnidad) {\n"
    ...
    private static String unidades(int idPer) {
