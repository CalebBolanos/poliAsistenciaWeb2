...
public class obtenerNotificaciones {
    ...
    public obtenerNotificaciones(int tipoNotificacion) {
        ...
        try {
            ...
            while (resultado.next()) {
                if ((resultado.getString("img").equals(" ")) || (resultado.getString("img") == null)) {
                    html +=   "                    <div class=\"mdl-cell mdl-cell--8-col\">\n"
                            ...
                            + "                                </div>\n"
                            + "                                <center>\n"
                            + "                                    <a href=\""+resultado.getString("url")+"\"><button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: rgb(0, 229, 10); width: 50%; margin: 5px;\">\n"
                            + "                                        Ver mas detalles\n"
                            + "                                    </button></a>\n"
                            + "                                    <button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: rgb(0, 229, 10); width: 50%;\" onclick=\"editarNotificacion("+resultado.getInt("idNoti")+");\">\n"
                            + "                                        Editar\n"
                            + "                                    </button>\n"
                            + "                                    <button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: red; width: 50%; margin: 5px;\" onclick=\"borrarNotificacion("+resultado.getInt("idNoti")+");\">\n"
                            + "                                        Borrar\n"
                            + "                                    </button>\n"
                            + "                                </center>\n"
                            + "                            </div>\n"
                    ...
                    html +=   "                    <div class=\"mdl-cell mdl-cell--8-col\">\n"
                            ...
                            + "                                </div>\n"
                            + "                                <center>\n"
                            + "                                    <a href=\""+resultado.getString("url")+"\"><button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: rgb(0, 229, 10); width: 50%;\">\n"
                            + "                                        Ver mas detalles\n"
                            + "                                    </button></a>\n"
                            + "                                    <button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: rgb(0, 229, 10); width: 50%;\" onclick=\"editarNotificacion("+resultado.getInt("idNoti")+");\">\n"
                            + "                                        Editar\n"
            ...
            if(html.equals("")){
                html = "<div class=\"mdl-cell mdl-cell--8-col\" style=\"color: gray; font-size:30px; padding-top: 10%;\"><center>No hay notificaciones en la bandeja de entrada</center></div>";
            }
