            ...
            while (resultado.next()) {
                if ((resultado.getString("img").equals(" ")) || (resultado.getString("img") == null)) {
                    html += "<div class=\"mdl-cell mdl-cell--8-col\" style=\"transition: all 0.3s cubic-bezier(.25,.8,.25,1); box-shadow: 0px 1px 2px rgba(0,0,0,0.09), 0 1px 2px rgba(0,0,0,0.25); border-radius: 3px 3px;  background-color: white\">\n"
                            ...
                            + "                            <div class=\"mdl-cell mdl-cell--4-col\" style=\"width: 50px; height: 50px; border-radius: 50%; background-repeat: no-repeat; background-position: center center; background-size: cover; background-image: url('sanic.jpg'); margin: 0px; padding: 0px; /**/position: relative; position: relative; float: left; display: flex; justify-content: center; align-content: center; flex-direction: column; text-align: center;\"></div>\n"
                            ...
                            + "                                <div style=\"font-weight: bold; font-size: 12px;\">Usuario</div>\n"
                            ...
                            + "                        <div class=\"mdl-grid\" style=\"margin: 0px; padding: 0px\">\n"
                            + "                            <div class=\"mdl-cell mdl-cell--2-col\" style=\"float: right;\">\n"
                            + "                                <button class=\"mdl-button mdl-js-button mdl-button--primary\" style=\"color: red; width: 100%; margin: 5px;\" onclick=\"borrarNotificacion('" + resultado.getInt("idNoti") + "');\">\n"
                            + "                                    Borrar\n"
                            + "                                </button>\n"
                            + "                            </div>\n"
                            + "                            <div class=\"mdl-cell mdl-cell--2-col\" style=\"float: right;\">\n"
                    ...
                    html += "  <div class=\"mdl-cell mdl-cell--8-col\" style=\"transition: all 0.3s cubic-bezier(.25,.8,.25,1); box-shadow: 0px 1px 2px rgba(0,0,0,0.09), 0 1px 2px rgba(0,0,0,0.25); border-radius: 3px 3px;  background-color: white\">\n"
                            ...
                            + "                        <img style=\"height: auto; width: 100%;\" src=\""+resultado.getString("img")+"\">\n"
                            + "                    </div>\n"
                            + "                </div>\n"
                            + "                <div class=\"mdl-grid\" style=\"margin: 0px; padding: 0px\">\n"
                            + "                    <div class=\"mdl-cell mdl-cell--12-col\" style=\"margin: 0px; padding: 0px\">\n"
