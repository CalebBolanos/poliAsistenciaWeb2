 ...
 * @author Caleb
 */
public class obtenerDatosAlumno {
    ...
    public  obtenerDatosAlumno(String boleta, String llave){
        conexion.cDatos base = new conexion.cDatos();
        try{
            base.conectar();
            ResultSet resultado = base.consulta("call spTraerDatos('"+boleta+"', '"+llave+"');");
            if(resultado.next()){
                if(resultado.getString("existe").equals("1")){
                    ...
                    _boleta = resultado.getString("bol");
